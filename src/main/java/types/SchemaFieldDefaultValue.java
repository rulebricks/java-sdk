...
@JsonDeserialize(
    using = SchemaFieldDefaultValue.Deserializer.class
)
public final class SchemaFieldDefaultValue {
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof SchemaFieldDefaultValue && equalTo((SchemaFieldDefaultValue) other);
  }
  ...
  static final class Deserializer extends StdDeserializer<SchemaFieldDefaultValue> {
    Deserializer() {
