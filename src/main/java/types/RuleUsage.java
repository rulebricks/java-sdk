...
@JsonDeserialize(
    builder = RuleUsage.Builder.class
)
public final class RuleUsage {
  ...
  private RuleUsage(Optional<String> id, Optional<String> name, Optional<String> description,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof RuleUsage && equalTo((RuleUsage) other);
  }
  ...
  private boolean equalTo(RuleUsage other) {
  ...
  public static final class Builder {
    ...
    public Builder from(RuleUsage other) {
      id(other.getId());
      name(other.getName());
    ...
    /**
     * <p>Whether the rule is published.</p>
     */
    @JsonSetter(
        value = "published",
        nulls = Nulls.SKIP
