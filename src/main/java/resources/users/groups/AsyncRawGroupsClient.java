...
public class AsyncRawGroupsClient {
   ...
   */
  public CompletableFuture<RulebricksApiHttpResponse<List<UserGroup>>> list() {
    return list(null);
  }
  ...
  public CompletableFuture<RulebricksApiHttpResponse<List<UserGroup>>> list(
    ...
    HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
      ...
      .addPathSegments("admin/users/groups");if (requestOptions != null) {
      ...
      CompletableFuture<RulebricksApiHttpResponse<List<UserGroup>>> future = new CompletableFuture<>();
        ...
        public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
          try (ResponseBody responseBody = response.body()) {
            ...
            if (response.isSuccessful()) {
              future.complete(new RulebricksApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, new TypeReference<List<UserGroup>>() {}), response));
              return;
            }
            try {
     ...
     */
    public CompletableFuture<RulebricksApiHttpResponse<UserGroup>> create(
     ...
     */
    public CompletableFuture<RulebricksApiHttpResponse<UserGroup>> create(
        CreateUserGroupRequest request, RequestOptions requestOptions) {
      HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
        ...
        CompletableFuture<RulebricksApiHttpResponse<UserGroup>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
          @Override
          public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
            try (ResponseBody responseBody = response.body()) {
              String responseBodyString = responseBody != null ? responseBody.string() : "{}";
              if (response.isSuccessful()) {
                future.complete(new RulebricksApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, UserGroup.class), response));
                return;
              }
              try {
