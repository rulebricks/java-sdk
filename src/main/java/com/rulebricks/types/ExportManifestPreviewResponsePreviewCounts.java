...
@JsonDeserialize(
    builder = ExportManifestPreviewResponsePreviewCounts.Builder.class
)
public final class ExportManifestPreviewResponsePreviewCounts {
  ...
  private ExportManifestPreviewResponsePreviewCounts(Optional<Integer> rules,
      Optional<Integer> flows, Optional<Integer> contexts, Optional<Integer> values,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof ExportManifestPreviewResponsePreviewCounts && equalTo((ExportManifestPreviewResponsePreviewCounts) other);
  }
  ...
  private boolean equalTo(ExportManifestPreviewResponsePreviewCounts other) {
  ...
  public static final class Builder {
    ...
    public Builder from(ExportManifestPreviewResponsePreviewCounts other) {
    ...
    public ExportManifestPreviewResponsePreviewCounts build() {
      return new ExportManifestPreviewResponsePreviewCounts(rules, flows, contexts, values, additionalProperties);
    }
