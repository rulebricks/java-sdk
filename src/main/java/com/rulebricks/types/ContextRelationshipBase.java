...
public final class ContextRelationshipBase implements IContextRelationshipBase {
  ...
  private ContextRelationshipBase(Optional<String> id,
  ...
  private boolean equalTo(ContextRelationshipBase other) {
    return id.equals(other.id) && relationType.equals(other.relationType) && foreignKeyFact.equals(other.foreignKeyFact) && name.equals(other.name) && description.equals(other.description) && createdAt.equals(other.createdAt);
  }

  @java.lang.Override
  public int hashCode() {
    return Objects.hash(this.id, this.relationType, this.foreignKeyFact, this.name, this.description, this.createdAt);
  }
  ...
  public static final class Builder {
    ...
    public ContextRelationshipBase build() {
      return new ContextRelationshipBase(id, relationType, foreignKeyFact, name, description, createdAt, additionalProperties);
    }
