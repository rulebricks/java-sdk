...
@JsonDeserialize(
    using = FlowExecutionResponsePayload.Deserializer.class
)
public final class FlowExecutionResponsePayload {
  private final Object value;

  private final int type;

  private FlowExecutionResponsePayload(Object value, int type) {
    this.value = value;
    this.type = type;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof FlowExecutionResponsePayload && equalTo((FlowExecutionResponsePayload) other);
  }

  private boolean equalTo(FlowExecutionResponsePayload other) {
  ...
  static final class Deserializer extends StdDeserializer<FlowExecutionResponsePayload> {
    Deserializer() {
      super(FlowExecutionResponsePayload.class);
    }

    @java.lang.Override
    public FlowExecutionResponsePayload deserialize(JsonParser p, DeserializationContext context)
        throws IOException {
