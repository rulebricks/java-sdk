...
@JsonDeserialize(
    builder = ListValue.Builder.class
)
public final class ListValue implements IDynamicValueBase {
  ...
  public static final class Builder {
    ...
    public Builder from(ListValue other) {
      id(other.getId());
      name(other.getName());
    ...
    public ListValue build() {
      return new ListValue(id, name, usages, accessGroups, value, additionalProperties);
    }
  }
}
