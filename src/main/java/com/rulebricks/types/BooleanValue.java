...
@JsonDeserialize(
    builder = BooleanValue.Builder.class
)
public final class BooleanValue implements IDynamicValueBase {
  ...
  private BooleanValue(Optional<String> id, Optional<String> name, Optional<List<RuleUsage>> usages,
      Optional<List<String>> accessGroups, Optional<Boolean> value,
  ...
  public static final class Builder {
    ...
    public Builder from(BooleanValue other) {
      id(other.getId());
      name(other.getName());
    ...
    public BooleanValue build() {
      return new BooleanValue(id, name, usages, accessGroups, value, additionalProperties);
    }
  }
}
