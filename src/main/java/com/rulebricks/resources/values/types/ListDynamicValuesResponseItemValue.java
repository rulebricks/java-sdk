...
@JsonDeserialize(
    using = ListDynamicValuesResponseItemValue.Deserializer.class
)
public final class ListDynamicValuesResponseItemValue {
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof ListDynamicValuesResponseItemValue && equalTo((ListDynamicValuesResponseItemValue) other);
  }
  ...
  static final class Deserializer extends StdDeserializer<ListDynamicValuesResponseItemValue> {
    Deserializer() {
      super(ListDynamicValuesResponseItemValue.class);
    }

    @java.lang.Override
    public ListDynamicValuesResponseItemValue deserialize(JsonParser p, DeserializationContext ctxt)
        throws IOException {
