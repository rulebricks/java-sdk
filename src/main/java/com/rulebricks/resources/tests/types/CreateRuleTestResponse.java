...
@JsonDeserialize(
    builder = CreateRuleTestResponse.Builder.class
)
public final class CreateRuleTestResponse {
  ...
  private CreateRuleTestResponse(String id, String name, Map<String, Object> request,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof CreateRuleTestResponse && equalTo((CreateRuleTestResponse) other);
  }
  ...
  private boolean equalTo(CreateRuleTestResponse other) {
  ...
  public interface IdStage {
    ...
    Builder from(CreateRuleTestResponse other);
  }
  ...
  public static final class Builder implements IdStage, NameStage, CriticalStage, ErrorStage, SuccessStage, _FinalStage {
    ...
    @java.lang.Override
    public Builder from(CreateRuleTestResponse other) {
      id(other.getId());
      name(other.getName());
    ...
    @java.lang.Override
    public CreateRuleTestResponse build() {
      return new CreateRuleTestResponse(id, name, request, response, critical, error, success, testState, lastExecuted, additionalProperties);
    }
  }
}
