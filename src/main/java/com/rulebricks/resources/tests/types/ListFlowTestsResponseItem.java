...
@JsonDeserialize(
    builder = ListFlowTestsResponseItem.Builder.class
)
public final class ListFlowTestsResponseItem {
  ...
  private ListFlowTestsResponseItem(String id, String name, Map<String, Object> request,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof ListFlowTestsResponseItem && equalTo((ListFlowTestsResponseItem) other);
  }
  ...
  private boolean equalTo(ListFlowTestsResponseItem other) {
  ...
  public interface IdStage {
    ...
    Builder from(ListFlowTestsResponseItem other);
  }
  ...
  public interface _FinalStage {
    ListFlowTestsResponseItem build();
  ...
  public static final class Builder implements IdStage, NameStage, CriticalStage, ErrorStage, SuccessStage, _FinalStage {
    ...
    @java.lang.Override
    public Builder from(ListFlowTestsResponseItem other) {
      id(other.getId());
      name(other.getName());
    ...
    @java.lang.Override
    public ListFlowTestsResponseItem build() {
      return new ListFlowTestsResponseItem(id, name, request, response, critical, error, success, testState, lastExecuted, additionalProperties);
    }
  }
}
