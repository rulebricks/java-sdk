...
@JsonDeserialize(
    builder = CreateFlowTestResponse.Builder.class
)
public final class CreateFlowTestResponse {
  ...
  private CreateFlowTestResponse(String id, String name, Map<String, Object> request,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof CreateFlowTestResponse && equalTo((CreateFlowTestResponse) other);
  }
  ...
  private boolean equalTo(CreateFlowTestResponse other) {
  ...
  public interface IdStage {
    ...
    Builder from(CreateFlowTestResponse other);
  }
  ...
  public static final class Builder implements IdStage, NameStage, CriticalStage, ErrorStage, SuccessStage, _FinalStage {
    ...
    @java.lang.Override
    public Builder from(CreateFlowTestResponse other) {
      id(other.getId());
      name(other.getName());
    ...
    @java.lang.Override
    public CreateFlowTestResponse build() {
      return new CreateFlowTestResponse(id, name, request, response, critical, error, success, testState, lastExecuted, additionalProperties);
    }
  }
}
