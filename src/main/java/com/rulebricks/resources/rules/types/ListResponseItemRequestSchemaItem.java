...
@JsonDeserialize(
    builder = ListResponseItemRequestSchemaItem.Builder.class
)
public final class ListResponseItemRequestSchemaItem {
  ...
  private ListResponseItemRequestSchemaItem(Optional<String> key, Optional<Boolean> show,
  ...
  /**
   * @return The key for the request field.
   */
  @JsonProperty("key")
  ...
  /**
   * @return The description of the request field.
   */
  ...
  /**
   * @return The data type of the request field.
   */
  @JsonProperty("type")
  ...
  /**
   * @return The default value of the request field.
   */
  ...
  /**
   * @return The computed default value of the request field.
   */
  ...
  /**
   * @return The transformation applied to the request field.
   */
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof ListResponseItemRequestSchemaItem && equalTo((ListResponseItemRequestSchemaItem) other);
  }
  ...
  private boolean equalTo(ListResponseItemRequestSchemaItem other) {
  ...
  public static final class Builder {
    ...
    public Builder from(ListResponseItemRequestSchemaItem other) {
      key(other.getKey());
      show(other.getShow());
      name(other.getName());
    ...
    public ListResponseItemRequestSchemaItem build() {
      return new ListResponseItemRequestSchemaItem(key, show, name, description, type, defaultValue, defaultComputedValue, transform, additionalProperties);
    }
  }
}
