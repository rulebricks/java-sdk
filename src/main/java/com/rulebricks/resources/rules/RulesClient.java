...
public class RulesClient {
   ...
   */
  public RuleExecutionResult solve(String slug, String version, SolveRulesRequest request) {
  ...
  public Map<String, Map<String, Object>> parallelSolve(
    ...
    return this.rawClient.parallelSolve(request).body();
  }
  ...
  public Map<String, Map<String, Object>> parallelSolve(
    ...
    return this.rawClient.parallelSolve(request, requestOptions).body();
  }
}
