...
public class AsyncRawFoldersClient {
   ...
   */
  public CompletableFuture<RulebricksApiHttpResponse<List<Folder>>> list() {
   ...
   * Retrieve all rule folders for the authenticated user.
   */
  public CompletableFuture<RulebricksApiHttpResponse<List<Folder>>> list(ListFoldersRequest request,
      RequestOptions requestOptions) {
    HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
      ...
      CompletableFuture<RulebricksApiHttpResponse<List<Folder>>> future = new CompletableFuture<>();
        ...
        public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
          try (ResponseBody responseBody = response.body()) {
            ...
            if (response.isSuccessful()) {
              future.complete(new RulebricksApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, new TypeReference<List<Folder>>() {}), response));
              return;
            }
            try {
     ...
     */
    public CompletableFuture<RulebricksApiHttpResponse<Folder>> upsert(
     ...
     * Create a new folder or update an existing one for the authenticated user. Folders are typed to organize rules (the default), flows, or contexts.
     */
    public CompletableFuture<RulebricksApiHttpResponse<Folder>> upsert(UpsertFolderRequest request,
        RequestOptions requestOptions) {
      HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
        ...
        CompletableFuture<RulebricksApiHttpResponse<Folder>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
          @Override
          public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
            try (ResponseBody responseBody = response.body()) {
              String responseBodyString = responseBody != null ? responseBody.string() : "{}";
              if (response.isSuccessful()) {
                future.complete(new RulebricksApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, Folder.class), response));
                return;
              }
              try {
       ...
       */
      public CompletableFuture<RulebricksApiHttpResponse<Folder>> delete(
       ...
       */
      public CompletableFuture<RulebricksApiHttpResponse<Folder>> delete(
          DeleteFolderRequest request, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
