...
@JsonDeserialize(
    builder = ListFlowsResponseItem.Builder.class
)
public final class ListFlowsResponseItem {
  ...
  private ListFlowsResponseItem(Optional<String> id, Optional<String> name,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof ListFlowsResponseItem && equalTo((ListFlowsResponseItem) other);
  }
  ...
  private boolean equalTo(ListFlowsResponseItem other) {
  ...
  public static final class Builder {
    ...
    public Builder from(ListFlowsResponseItem other) {
      id(other.getId());
      name(other.getName());
    ...
    public ListFlowsResponseItem build() {
      return new ListFlowsResponseItem(id, name, description, published, slug, updatedAt, additionalProperties);
    }
  }
}
