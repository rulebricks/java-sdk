...
public final class ListRulesRequest {
  ...
  private ListRulesRequest(Optional<List<String>> labels, Optional<String> id,
  ...
  public static final class Builder {
    ...
    public ListRulesRequest build() {
      return new ListRulesRequest(labels, id, slug, search, version, folder, userGroup, name, additionalProperties);
    }
